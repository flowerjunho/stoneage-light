...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    default: "inline-flex h-12 items-center justify-center rounded-2xl bg-bg-tertiary/50 backdrop-blur-sm p-1.5 text-text-secondary gap-1 border border-border/30",
    pills: "inline-flex items-center gap-2 p-1",
    underline: "inline-flex items-center gap-6 border-b border-border/30 pb-px",
    floating: "inline-flex items-center gap-2 p-2 rounded-2xl bg-bg-secondary/30 backdrop-blur-xl border border-white/5",
  }
...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    default: cn(
      "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-medium",
    ...
    pills: cn(
      "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-5 py-2 text-sm font-medium",
    ...
    underline: cn(
      "relative inline-flex items-center justify-center gap-2 whitespace-nowrap pb-3 text-sm font-medium",
...
>(({ className, animated = true, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      animated && "data-[state=active]:animate-slide-up",
      className
    )}
    {...props}
  />
