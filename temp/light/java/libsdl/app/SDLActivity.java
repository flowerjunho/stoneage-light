...
import com.stoneage.light.KoUtil$$ExternalSyntheticApiModelOutline0;
...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (!mBrokenLibraries) {
            String str = String.valueOf(3) + "." + String.valueOf(2) + "." + String.valueOf(10);
        ...
        SDLSurface sDLSurfaceCreateSDLSurface = createSDLSurface(this);
        mSurface = sDLSurfaceCreateSDLSurface;
        sDLSurfaceCreateSDLSurface.setFitsSystemWindows(false);
    ...
    */
    ...
    public static boolean handleKeyEvent(View view, int i, KeyEvent keyEvent, InputConnection inputConnection) {
        ...
        if ((source & InputDeviceCompat.SOURCE_MOUSE) == 8194 && !isVRHeadset() && ((i == 4 || i == 125) && ((action = keyEvent.getAction()) == 0 || action == 1))) {
            return true;
        }
        if (keyEvent.getAction() == 0) {
            onNativeKeyDown(i);
    ...
    protected void messageboxCreateAndShow(Bundle bundle) {
        ...
        for (int i6 = 0; i6 < stringArray.length; i6++) {
            ...
            if (i8 != 0) {
                ...
                if ((intArray2[i6] & 2) != 0) {
                    sparseArray.put(WKSRecord.Service.SUNRPC, button);
                }
            }
    ...
    public static boolean setCustomCursor(int i) {
        if (Build.VERSION.SDK_INT >= 24) {
            try {
                mSurface.setPointerIcon(KoUtil$$ExternalSyntheticApiModelOutline0.m(mCursors.get(Integer.valueOf(i))));
                return true;
            } catch (Exception unused) {
            }
        }
