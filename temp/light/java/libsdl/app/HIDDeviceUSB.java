...
class HIDDeviceUSB implements HIDDevice {
    ...
    public int writeReport(byte[] bArr, boolean z) {
        ...
        if (z) {
            ...
            int iControlTransfer = usbDeviceConnection.controlTransfer(33, 9, b2 | 768, this.mInterface, bArr, i, length, 1000);
    ...
    public boolean readReport(byte[] bArr, boolean z) {
        ...
        int iControlTransfer = usbDeviceConnection.controlTransfer(161, 1, ((z ? 3 : 1) << 8) | b2, this.mInterface, bArr, i2, i, 1000);
        if (iControlTransfer < 0) {
        ...
        this.mManager.HIDDeviceReportResponse(this.mDeviceId, iControlTransfer == i ? bArr : Arrays.copyOfRange(bArr, 0, iControlTransfer));
        return true;
    }
